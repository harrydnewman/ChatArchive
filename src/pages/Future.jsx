...
<Navbar currentPage={'/future'}/>
        <div className={styles.futureDiv}>
            ...
            <p>The Metaverse: in immersive spaces there will be a chat upheld, along with <strong>more representative digital avatars</strong> - this links back to the <a href='/artifacts/graffiti'>Pasquino statue</a> the “talking statues”, and to bitmojis and profile pictures in <a href='/artifacts/privatemessaging'>online messaging</a>. </p>
            ...
            <p>And maybe we will have devices like the Apple Vision Pro that allow capture us “air drawing”, and we will go back to <a href='/artifacts/letters'>writing letters</a> and notes.</p>
            <ScrollToTop />
        </div>
        </div>
    )
