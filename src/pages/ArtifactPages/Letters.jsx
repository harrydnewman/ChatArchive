...
export default function Letters(){
    return (
        <div className={styles.archivePageDiv}>
            ...
            <ImageRightTextLeft text={`<strong>Passing on physical word</strong><br><br>The invention of written language evolved from spoken language and shorthand pictograms.`} image={letterImage1}/>
