...
export default function Graffiti(){
    return (
        <div className={styles.archivePageDiv}>
           ...
           <ImageLeftTextRight text={`<strong>The first public chat forum Third century BC</strong><br><br>The statue is known as The Pasquino Statue - the first of the <u>talking statues of Rome,</u> a series of statues with attached anonymous criticisms to its base.`} image={graffitiimage1}/>
           <AboutText text={`Arguably the first written <a href="/artifacts/publicthreads">public chat forum.</a>`} />
