...
export default function PublicThreads(){
    return (
        <div className={styles.archivePageDiv}>
             ...
             <AboutText text={`The <a href="/artifacts/graffiti">public chat forum</a> on the internet <strong>where anyone can contribute to a commentary</strong>. This chat doesn’t always have a tightly coupled responder. Sometimes, your end of the chat is just yelling into the void. You can also target a single recipient by responding to a user in a thread. `} />
